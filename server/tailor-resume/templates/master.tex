...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{<<LINKEDIN_URL>>}{\color{black}{\footnotesize\faLinkedinIn}\hspace*{0.13cm}<<LINKEDIN_USER>>}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{<<GITHUB_URL>>}{\color{black}{\footnotesize\faGithub}\hspace*{0.13cm}<<GITHUB_USER>>}}%
    \end{header}
